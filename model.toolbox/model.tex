...
\fl{}\moduleLeftDash\cl{ {\MODULE} model}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Integers ,\, Naturals ,\, Sequences ,\, TLC}
\fl{}
\fl{ {\CONSTANT} Input\_type ,\, Input\_priority ,\, Max\_ready}
\fl{}
 \fl{ MakeTasks ( type ,\, prioryty ,\, status ) \.{\defeq} [ type \.{\mapsto}
 type ,\, prioryty \.{\mapsto} prioryty ,\, status \.{\mapsto} status ]}
\fl{}
\fl{ {\p@mmalgorithm} model {\p@lbrace}}
\fl{}
\fl{}
\fl{}
\fl{ {\p@variable}}\al{11}{1}{ ready \.{=} 0 ,\,}
\fl{ run \.{=} 0 ,\,}
 \fl{ prioritys \.{=} [ i \.{\in} 0 \.{\dotdot} 3 \.{\mapsto} {\langle}
 {\rangle} ] ,\,}
 \fl{ tasks \.{=} [ i \.{\in} 1 \.{\dotdot} Len ( Input\_priority )
 \.{\mapsto} MakeTasks ( Input\_type [ i ] ,\, Input\_priority [ i ]
 ,\,\@w{suspended} ) ]}
\fl{}
\fl{ {\p@process} ( planing\_task \.{\in} 1 \.{\dotdot} Len ( tasks ) )}
\fl{ \{}
\fl{ plan\_loop\@s{.5}\textrm{:}\@s{3}}
\fl{ {\p@while} ( {\TRUE} ) \{}
\fl{ {\p@either} \{}
\fl{}
 \fl{ {\p@await} \.{\land} tasks [ self ] . status \.{=}\@w{suspended}
 \.{\land} ready \.{<} Max\_ready {\p@semicolon}}
\fl{}
 \fl{ prioritys [ tasks [ self ] . priority ] \.{:=} Append ( prioritys [
 tasks [ self ] . priority ] ,\, self ) {\p@semicolon}}
\fl{ tasks [ self ] . status \.{:=}\@w{ready} {\p@semicolon}}
\fl{ ready \.{:=} ready \.{+} 1 {\p@semicolon}}
\fl{ \}}
\fl{ {\p@or}}\al{28}{1}{ \{}
\fl{}
 \fl{ {\p@await}}\al{30}{1}{ \.{\land}}\al{30}{2}{ tasks [ self ] . status
 \.{=}\@w{ready}}
\fl{ \.{\land}}\al{31}{1}{ run \.{=} 0}
 \fl{ \.{\land}}\al{32}{1}{ Head ( prioritys [ tasks [ self ] . priority ] )
 \.{=} self}
 \fl{ \.{\land}}\al{33}{1}{ \A\, j \.{\in} ( tasks [ self ] . priority \.{+} 1
 ) \.{\dotdot} 3 \.{:} Len ( prioritys [ j ] ) \.{=} 0 {\p@semicolon}}
\fl{}
\fl{ tasks [ self ] . status \.{:=}\@w{running} {\p@semicolon}}
\fl{}
 \fl{ prioritys [ tasks [ self ] . priority ] \.{:=} Tail ( prioritys [ tasks
 [ self ] . priority ] ) {\p@semicolon}}
\fl{ ready \.{:=} ready \.{-} 1 {\p@semicolon}}
\fl{ run \.{:=} self {\p@semicolon}}
\fl{ \}}
\fl{ {\p@or}}\al{41}{1}{ \{}
\fl{}
 \fl{ {\p@await}}\al{43}{1}{ \.{\land}}\al{43}{2}{ tasks [ self ] . status
 \.{=}\@w{running}}
 \fl{ \.{\land}}\al{44}{1}{ \A\, j \.{\in} ( tasks [ self ] . priority \.{+} 1
 ) \.{\dotdot} 3 \.{:} Len ( prioritys [ j ] ) \.{=} 0 {\p@semicolon}}
\fl{}
\fl{ tasks [ self ] . status \.{:=}\@w{suspended} {\p@semicolon}}
\fl{ run \.{:=} 0 {\p@semicolon}}
\fl{ \}}
\fl{ {\p@or}}\al{49}{1}{ \{}
\fl{}
 \fl{ {\p@await}}\al{51}{1}{ \.{\land}}\al{51}{2}{ tasks [ self ] . status
 \.{=}\@w{ready}}
 \fl{ \.{\land}}\al{52}{1}{ Head ( prioritys [ tasks [ self ] . priority ] )
 \.{=} self}
 \fl{ \.{\land}}\al{53}{1}{ \A\, j \.{\in} ( tasks [ self ] . priority \.{+} 1
 ) \.{\dotdot} 3 \.{:} Len ( prioritys [ j ] ) \.{=} 0}
\fl{ \.{\land}}\al{54}{1}{ run \.{\neq} 0}
 \fl{ \.{\land}}\al{55}{1}{ tasks [ run ] . priority \.{<} tasks [ self ] .
 priority {\p@semicolon}}
\fl{}
 \fl{ prioritys [ tasks [ run ] . priority ] \.{:=} Append ( prioritys [ tasks
 [ run ] . priority ] ,\, run ) \.{\p@barbar}}
 \fl{ prioritys [ tasks [ self ] . priority ] \.{:=} Tail ( prioritys [ tasks
 [ self ] . priority ] ) {\p@semicolon}}
\fl{ tasks [ run ] . status \.{:=}\@w{ready} \.{\p@barbar}}
\fl{ tasks [ self ] . status \.{:=}\@w{running} {\p@semicolon}}
\fl{ run \.{:=} self {\p@semicolon}}
\fl{ \}}
\fl{ {\p@or}}\al{63}{1}{ \{}
\fl{}
 \fl{ {\p@await}}\al{65}{1}{ \.{\land}}\al{65}{2}{ tasks [ self ] . status
 \.{=}\@w{running}}
\fl{ \.{\land}}\al{66}{1}{ tasks [ self ] . type \.{=}\@w{A}}
 \fl{ \.{\land}}\al{67}{1}{ \A\, j \.{\in} ( tasks [ self ] . priority \.{+} 1
 ) \.{\dotdot} 3 \.{:} Len ( prioritys [ j ] ) \.{=} 0 {\p@semicolon}}
\fl{}
\fl{ tasks [ self ] . status \.{:=}\@w{waiting} {\p@semicolon}}
\fl{ run \.{:=} 0 {\p@semicolon}}
\fl{ \}}
\fl{ {\p@or}}\al{72}{1}{ \{}
\fl{}
 \fl{ {\p@await}}\al{74}{1}{ \.{\land}}\al{74}{2}{ tasks [ self ] . status
 \.{=}\@w{waiting}}
\fl{ \.{\land}}\al{75}{1}{ tasks [ self ] . type \.{=}\@w{A}}
\fl{ \.{\land}}\al{76}{1}{ ready \.{<} Max\_ready {\p@semicolon}}
 \fl{ prioritys [ tasks [ self ] . priority ] \.{:=} Append ( prioritys [
 tasks [ self ] . priority ] ,\, self ) {\p@semicolon}}
\fl{ tasks [ self ] . status \.{:=}\@w{ready} {\p@semicolon}}
\fl{ ready \.{:=} ready \.{+} 1 {\p@semicolon}}
...
\fl{}
\fl{}
\fl{ {\VARIABLES} ready ,\, run ,\, prioritys ,\, tasks}
\fl{}
 \fl{ vars \.{\defeq} {\langle} ready ,\, run ,\, prioritys ,\, tasks
 {\rangle}}
\fl{}
\fl{ ProcSet \.{\defeq} ( 1 \.{\dotdot} Len ( tasks ) )}
\fl{}
\fl{ Init \.{\defeq}}\al{94}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land}}\al{95}{1}{ ready \.{=} 0}
\fl{ \.{\land}}\al{96}{1}{ run \.{=} 0}
 \fl{ \.{\land}}\al{97}{1}{ prioritys \.{=} [ i \.{\in} 0 \.{\dotdot} 3
 \.{\mapsto} {\langle} {\rangle} ]}
 \fl{ \.{\land}}\al{98}{1}{ tasks \.{=} [ i \.{\in} 1 \.{\dotdot} Len (
 Input\_priority ) \.{\mapsto} MakeTasks ( Input\_type [ i ] ,\,
 Input\_priority [ i ] ,\,\@w{suspended} ) ]}
\fl{}
 \fl{ planing\_task ( self ) \.{\defeq}}\al{100}{5}{ \.{\lor}}\al{100}{6}{
 \.{\land}}\al{100}{7}{ \.{\land} tasks [ self ] . status \.{=}\@w{suspended}
 \.{\land} ready \.{<} Max\_ready}
 \fl{ \.{\land}}\al{101}{1}{ prioritys \.{'} \.{=} [ prioritys {\EXCEPT}
 {\bang} [ tasks [ self ] . priority ] \.{=} Append ( prioritys [ tasks [
 self ] . priority ] ,\, self ) ]}
 \fl{ \.{\land}}\al{102}{1}{ tasks \.{'}}\al{102}{3}{ \.{=}}\al{102}{4}{ [
 tasks {\EXCEPT} {\bang} [ self ] . status \.{=}\@w{ready} ]}
 \fl{ \.{\land}}\al{103}{1}{ ready \.{'}}\al{103}{3}{ \.{=}}\al{103}{4}{ ready
 \.{+} 1}
\fl{ \.{\land}}\al{104}{1}{ run \.{'} \.{=} run}
 \fl{ \.{\lor}}\al{105}{1}{ \.{\land}}\al{105}{2}{ \.{\land}}\al{105}{3}{
 tasks [ self ] . status \.{=}\@w{ready}}
\fl{ \.{\land}}\al{106}{1}{ run \.{=} 0}
 \fl{ \.{\land}}\al{107}{1}{ Head ( prioritys [ tasks [ self ] . priority ] )
 \.{=} self}
 \fl{ \.{\land}}\al{108}{1}{ \A\, j \.{\in} ( tasks [ self ] . priority \.{+}
 1 ) \.{\dotdot} 3 \.{:} Len ( prioritys [ j ] ) \.{=} 0}
 \fl{ \.{\land}}\al{109}{1}{ tasks \.{'} \.{=} [ tasks {\EXCEPT} {\bang} [
 self ] . status \.{=}\@w{running} ]}
 \fl{ \.{\land}}\al{110}{1}{ prioritys \.{'} \.{=} [ prioritys {\EXCEPT}
 {\bang} [ tasks \.{'} [ self ] . priority ] \.{=} Tail ( prioritys [ tasks
 \.{'} [ self ] . priority ] ) ]}
\fl{ \.{\land}}\al{111}{1}{ ready \.{'} \.{=} ready \.{-} 1}
\fl{ \.{\land}}\al{112}{1}{ run \.{'} \.{=} self}
 \fl{ \.{\lor}}\al{113}{1}{ \.{\land}}\al{113}{2}{ \.{\land}}\al{113}{3}{
 tasks [ self ] . status \.{=}\@w{running}}
 \fl{ \.{\land}}\al{114}{1}{ \A\, j \.{\in} ( tasks [ self ] . priority \.{+}
 1 ) \.{\dotdot} 3 \.{:} Len ( prioritys [ j ] ) \.{=} 0}
 \fl{ \.{\land}}\al{115}{1}{ tasks \.{'} \.{=} [ tasks {\EXCEPT} {\bang} [
 self ] . status \.{=}\@w{suspended} ]}
\fl{ \.{\land}}\al{116}{1}{ run \.{'} \.{=} 0}
 \fl{ \.{\land}}\al{117}{1}{ {\UNCHANGED} {\langle} ready ,\, prioritys
 {\rangle}}
 \fl{ \.{\lor}}\al{118}{1}{ \.{\land}}\al{118}{2}{ \.{\land}}\al{118}{3}{
 tasks [ self ] . status \.{=}\@w{ready}}
 \fl{ \.{\land}}\al{119}{1}{ Head ( prioritys [ tasks [ self ] . priority ] )
 \.{=} self}
 \fl{ \.{\land}}\al{120}{1}{ \A\, j \.{\in} ( tasks [ self ] . priority \.{+}
 1 ) \.{\dotdot} 3 \.{:} Len ( prioritys [ j ] ) \.{=} 0}
\fl{ \.{\land}}\al{121}{1}{ run \.{\neq} 0}
 \fl{ \.{\land}}\al{122}{1}{ tasks [ run ] . priority \.{<} tasks [ self ] .
 priority}
 \fl{ \.{\land}}\al{123}{1}{ prioritys \.{'} \.{=} [ prioritys
 {\EXCEPT}}\al{123}{7}{ {\bang}}\al{123}{8}{ [ tasks [ run ] . priority ]
 \.{=} Append ( prioritys [ tasks [ run ] . priority ] ,\, run ) ,\,}
 \fl{ {\bang}}\al{124}{1}{ [ tasks [ self ] . priority ] \.{=} Tail (
 prioritys [ tasks [ self ] . priority ] ) ]}
 \fl{ \.{\land}}\al{125}{1}{ tasks \.{'} \.{=} [ tasks {\EXCEPT}}\al{125}{7}{
 {\bang}}\al{125}{8}{ [ run ] . status \.{=}\@w{ready} ,\,}
\fl{ {\bang}}\al{126}{1}{ [ self ] . status \.{=}\@w{running} ]}
\fl{ \.{\land}}\al{127}{1}{ run \.{'} \.{=} self}
\fl{ \.{\land}}\al{128}{1}{ ready \.{'} \.{=} ready}
 \fl{ \.{\lor}}\al{129}{1}{ \.{\land}}\al{129}{2}{ \.{\land}}\al{129}{3}{
 tasks [ self ] . status \.{=}\@w{running}}
\fl{ \.{\land}}\al{130}{1}{ tasks [ self ] . type \.{=}\@w{A}}
 \fl{ \.{\land}}\al{131}{1}{ \A\, j \.{\in} ( tasks [ self ] . priority \.{+}
 1 ) \.{\dotdot} 3 \.{:} Len ( prioritys [ j ] ) \.{=} 0}
 \fl{ \.{\land}}\al{132}{1}{ tasks \.{'} \.{=} [ tasks {\EXCEPT} {\bang} [
 self ] . status \.{=}\@w{waiting} ]}
\fl{ \.{\land}}\al{133}{1}{ run \.{'} \.{=} 0}
 \fl{ \.{\land}}\al{134}{1}{ {\UNCHANGED} {\langle} ready ,\, prioritys
 {\rangle}}
 \fl{ \.{\lor}}\al{135}{1}{ \.{\land}}\al{135}{2}{ \.{\land}}\al{135}{3}{
 tasks [ self ] . status \.{=}\@w{waiting}}
\fl{ \.{\land}}\al{136}{1}{ tasks [ self ] . type \.{=}\@w{A}}
\fl{ \.{\land}}\al{137}{1}{ ready \.{<} Max\_ready}
 \fl{ \.{\land}}\al{138}{1}{ prioritys \.{'} \.{=} [ prioritys {\EXCEPT}
 {\bang} [ tasks [ self ] . priority ] \.{=} Append ( prioritys [ tasks [
 self ] . priority ] ,\, self ) ]}
 \fl{ \.{\land}}\al{139}{1}{ tasks \.{'}}\al{139}{3}{ \.{=}}\al{139}{4}{ [
 tasks {\EXCEPT} {\bang} [ self ] . status \.{=}\@w{ready} ]}
 \fl{ \.{\land}}\al{140}{1}{ ready \.{'}}\al{140}{3}{ \.{=}}\al{140}{4}{ ready
 \.{+} 1}
\fl{ \.{\land}}\al{141}{1}{ run \.{'} \.{=} run}
\fl{}
 \fl{ Next}\al{143}{1}{ \.{\defeq}}\al{143}{2}{ ( \E\, self \.{\in} 1
 \.{\dotdot} Len ( tasks ) \.{:} planing\_task ( self ) )}
\fl{}
 \fl{ Spec}\al{145}{1}{ \.{\defeq}}\al{145}{2}{ Init \.{\land} {\Box} [ Next
 ]_{ vars}}
\fl{}
\fl{}
\fl{}
